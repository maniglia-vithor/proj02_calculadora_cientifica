...
try:
    ...
    print(f"Error: {e}")  # Captura e exibe erros relacionados a valores inválidos (ex: entrada não numérica ou operador inválido)
except ZeroDivisionError as e:
    print(f"Error: {e}")  # Captura tentativas de divisão por zero
except Exception as e:
    print(f"Ocorreu um erro inesperado: {e}")  # Captura qualquer outro erro não previsto